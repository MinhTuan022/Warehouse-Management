...
public class Tai_Khoan extends javax.swing.JFrame {
    ...
    public ArrayList<TaiKhoan> DanhSachXuatKho;
    public long count, SoTrang, Trang = 1;
    
    public Tai_Khoan(){
        initComponents();
    }
     public Tai_Khoan(int ID_Nv)
    {
        this.ID_Nv=ID_Nv;
        DanhSachXuatKho = DAO.DangNhap.getInstance().getListTaiKhoan();
    ...
    private void initComponents() {
        ...
        tbTK.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Nhân Viên", "Tên Đăng Nhập", "Mật Khẩu", "Loại"
            }
        ) {
        ...
        tbTK.setRowHeight(50);
        tb.setViewportView(tbTK);
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnRefresh))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tb, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void btnxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxoaActionPerformed
           int selectedRowIndex = tbTK.getSelectedRow();
        int id = tbTK.getValueAt(selectedRowIndex, 0).hashCode();
        
        JFrame ThongBao = new XacNhan("TaiKhoan",id,ID_Nv);
        ThongBao.setVisible(true);         // TODO add your handling code here:
    }//GEN-LAST:event_btnxoaActionPerformed

    private void btnthemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemActionPerformed
        // TODO add your handling code here:
        JFrame Them = new Them_TK(ID_Nv);
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        ...
        validate();
        repaint();
        DuLieuMau = DangNhap.getInstance().getListTaiKhoan();
        build();
     ...
     public void build()
    {
        ...
        JTrang.setText("1");
        ArrayList<TaiKhoan> table = DAO.DangNhap.getInstance().get20TaiKhoan(DanhSachXuatKho, 1);
        listDanhSachTaiKhoan(table);

    }
    public void listDanhSachTaiKhoan(ArrayList<TaiKhoan> arr){
        DefaultTableModel model = (DefaultTableModel) tbTK.getModel();
        while (tbTK.getRowCount() > 0) {
            model.removeRow(0);
        }
        arr.stream().forEach((item) -> {
            
            model.addRow(new Object[]{item.ID_Nv,item.Ten_Tai_Khoan, item.Mat_Khau, item.Loai});
        });
