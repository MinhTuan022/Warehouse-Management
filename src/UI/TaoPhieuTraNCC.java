 ...
 * @author P50
 */
public class TaoPhieuTraNCC extends javax.swing.JFrame {
    ...
    public int ID_Lo_Sp;
    public TaoPhieuTraNCC() {
        initComponents();
     
    }
    public TaoPhieuTraNCC(int ID_Nv,int ID_Lo_Sp) {
        initComponents();
        ...
        public void getNhanVien()
    {
        ...
        NhanVien nv=null;
        //if(tk!=null)
        nv =DAO.DangNhap.getInstance().getNhanVien(ID_Nv);
        String tennv =null;
        if(nv==null) tennv="";
    ...
    public void ThongTin()
    {
        ...
        //XuatKho px = DAO.dPhieuXuat.getInstance().getXuatKho(lsp.ID_Lo_Sp);
        //TaiKhoan tk = DAO.DangNhap.getInstance().getTaiKhoan(101);
        //PhieuTraNCC pt = DAO.dPhieuTraNCC.getInstance().getTraKhoNCC(ncc.ID_Nha_Cc);
        //NhanVien nv = DAO.DangNhap.getInstance().getNhanVien();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Phiếu Trả Kho Siêu Thị");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        if(DAO.dPhieuTraNCC.getInstance().InsertPhieuTra(ID_Lo_Sp,ID_Nv))
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaoPhieuTraNCC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TaoPhieuTraNCC(101,102).setVisible(true);
            }
        });
    }
